...
class CreateAllTables extends Migration
{
    public function up()
    {
        ...
        if (!Schema::hasTable('cycle_configs')) {
        ...
        if (!Schema::hasTable('reviewer_grading')) {
        ...
        if (!Schema::hasTable('project_college')) {
        ...
        if (!Schema::hasTable('project_contributions')) {
        ...
        if (!Schema::hasTable('project_outcomes')) {
        ...
        if (!Schema::hasTable('project_pillar')) {
        ...
        if (!Schema::hasTable('project_researchers')) {
        ...
        if (!Schema::hasTable('final_report_grading')) {
        ...
        if (!Schema::hasTable('progress_report_grading')) {
