...
$idp_host = env('SAML2_'.$this_idp_env_id.'_IDP_HOST', 'https://mocksaml.com/api/saml/sso');
...
return $settings = array(
    ...
    'idp' => array(
        ...
        'entityId' => env('SAML2_'.$this_idp_env_id.'_IDP_ENTITYID', 'https://sts.qu.edu.qa/adfs/services/trust'),
        // SSO endpoint info of the IdP. (Authentication Request protocol)
        'singleSignOnService' => array(
            // URL Target of the IdP where the SP will send the Authentication Request Message,
            // using HTTP-Redirect binding.
            'url' => env('SAML2_'.$this_idp_env_id.'_IDP_SSO_URL',   'https://sts.qu.edu.qa/adfs/ls/'),
        ),
        ...
        'singleLogoutService' => array(
            ...
            'url' => env('SAML2_'.$this_idp_env_id.'_IDP_SL_URL', $idp_host . 'https://sts.qu.edu.qa/adfs/ls/'),
        ),
