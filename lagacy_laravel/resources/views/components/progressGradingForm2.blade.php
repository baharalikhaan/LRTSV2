...
<form method="POST" action="{{ route('progressGrade') }}">
    ...
    <ol type="a">
        ...
        <li>
            ...
            <select id="achievementsRating" name="achievementsRating" autocomplete="off">
                ...
                <option value="1" {{ old('achievementsRating', $progressComments2 != null ? $progressComments2->achievementsRating : '') == 1 ? 'selected' : '' }}>1</option>
                <option value="2" {{ old('achievementsRating', $progressComments2 != null ? $progressComments2->achievementsRating : '') == 2 ? 'selected' : '' }}>2</option>
                <option value="3" {{ old('achievementsRating', $progressComments2 != null ? $progressComments2->achievementsRating : '') == 3 ? 'selected' : '' }}>3</option>
                <option value="4" {{ old('achievementsRating', $progressComments2 != null ? $progressComments2->achievementsRating : '') == 4 ? 'selected' : '' }}>4</option>
                <option value="5" {{ old('achievementsRating', $progressComments2 != null ? $progressComments2->achievementsRating : '') == 5 ? 'selected' : '' }}>5</option>

            </select>
            <br>
            <textarea id="achievementsComments" name="achievementsComments" rows="4" cols="40"
                placeholder="comments upto 500 characters (optional)">{{ old('achievementsComments', $progressComments2->achievementsComments ?? '') }}</textarea>
    ...
    <ol type="a">
        ...
        <select id="publicationsRating" name="publicationsRating" autocomplete="off">
            ...
            <option value="1" {{ old('publicationsRating', $progressComments2 != null ? $progressComments2->publicationsRating : '') == 1 ? 'selected' : '' }}>1</option>
            <option value="2" {{ old('publicationsRating', $progressComments2 != null ? $progressComments2->publicationsRating : '') == 2 ? 'selected' : '' }}>2</option>
            <option value="3" {{ old('publicationsRating', $progressComments2 != null ? $progressComments2->publicationsRating : '') == 3 ? 'selected' : '' }}>3</option>
            <option value="4" {{ old('publicationsRating', $progressComments2 != null ? $progressComments2->publicationsRating : '') == 4 ? 'selected' : '' }}>4</option>
            <option value="5" {{ old('publicationsRating', $progressComments2 != null ? $progressComments2->publicationsRating : '') == 5 ? 'selected' : '' }}>5</option>

        </select>
        <br>
        <textarea id="publicationsComments" name="publicationsComments" rows="4" cols="40"
            placeholder="comments upto 500 characters (optional)">{{ old('publicationsComments', $progressComments2 != null ? $progressComments2->publicationsComments : '') }}</textarea>
    ...
    <ol type="a">
        ...
        <select id="studentsRating" name="studentsRating" autocomplete="off">
            ...
            <option value="1" {{ old('studentsRating', $progressComments2 != null ? $progressComments2->studentsRating : '') == 1 ? 'selected' : '' }}>1</option>
            <option value="2" {{ old('studentsRating', $progressComments2 != null ? $progressComments2->studentsRating : '') == 2 ? 'selected' : '' }}>2</option>
            <option value="3" {{ old('studentsRating', $progressComments2 != null ? $progressComments2->studentsRating : '') == 3 ? 'selected' : '' }}>3</option>
            <option value="4" {{ old('studentsRating', $progressComments2 != null ? $progressComments2->studentsRating : '') == 4 ? 'selected' : '' }}>4</option>
            <option value="5" {{ old('studentsRating', $progressComments2 != null ? $progressComments2->studentsRating : '') == 5 ? 'selected' : '' }}>5</option>
        ...
        <textarea id="studentsComments" name="studentsComments" rows="4" cols="40"
            placeholder="comments upto 500 characters (optional)">{{ old('studentsComments', $progressComments2 != null ? $progressComments2->studentsComments : '') }}</textarea>
        ...
        <div class="container d-flex justify-content-center align-items-center">
            ...
            @if ($progressComments2)
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    <label class="btn btn-toggle {{ $progressComments2->ethical == 1 ? 'active' : '' }}">
                        <input type="radio" name="ethical" value="1" autocomplete="off"
                            @if ($progressComments2->ethical == 1) checked @endif> YES
                    </label>
                    <label class="btn btn-toggle {{ $progressComments2->ethical == -1 ? 'active' : '' }}">
                        <input type="radio" name="ethical" value="-1" autocomplete="off"
                            @if ($progressComments2->ethical == -1) checked @endif> N/A
                    </label>
                    <label class="btn btn-toggle {{ $progressComments2->ethical == 0 ? 'active' : '' }}">
                        <input type="radio" name="ethical" value="0" autocomplete="off"
                            @if ($progressComments2->ethical == 0) checked @endif> NO
                    </label>
                </div>
            @else
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
    ...
    <ol type="a">
        ...
        <select id="budgetRating" name="budgetRating" autocomplete="off">
            <option value="1" {{ old('budgetRating', $progressComments2 != null ? $progressComments2->budgetRating : '') == 1 ? 'selected' : '' }}>1</option>
            <option value="2" {{ old('budgetRating', $progressComments2 != null ? $progressComments2->budgetRating : '') == 2 ? 'selected' : '' }}>2</option>
            <option value="3" {{ old('budgetRating', $progressComments2 != null ? $progressComments2->budgetRating : '') == 3 ? 'selected' : '' }}>3</option>
            <option value="4" {{ old('budgetRating', $progressComments2 != null ? $progressComments2->budgetRating : '') == 4 ? 'selected' : '' }}>4</option>
            <option value="5" {{ old('budgetRating', $progressComments2 != null ? $progressComments2->budgetRating : '') == 5 ? 'selected' : '' }}>5</option>
        </select>
        <br>

        <textarea id="budgetComments" name="budgetComments" rows="4" cols="40"
            placeholder="comments upto 500 characters (optional)">{{ old('budgetComments', $progressComments2 != null ? $progressComments2->budgetComments : '') }}</textarea>
        ...
        <div class="vc-toggle-container" style="align:center;">
            <label class="vc-switch">
                <input type="checkbox" class="vc-switch-input" id="isAccepted" name="isAccepted"
                    {{ $progressComments2 != null ? ($progressComments2->isAccepted == 1 ? 'checked' : '') : '' }} />
