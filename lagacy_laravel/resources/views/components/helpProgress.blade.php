        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">PROGRESS REPORT form help</h5>
                ...
                <div class="modal-body">
                    <b>A. Analysis</b>
                    <ul>
                        <li>Information about Analysis</li>

                    </ul>
                    <b>B. Summative Comments and Remarks</b>
                    <ul>
                        <li>Information about Summative Comments and Remarks</li>

                    </ul>
                    <b>C. Recommendation</b>
                    <ul>
                        <li>Information about Recommendation</li>
