...
<body class="body">
    ...
    <div class="container bg3" id="box-form"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select id="user-type" name="type" class="form-control">
                                ...
                                <option value="Admin+LPI">Admin+LPI</option>
                        ...
                        <div class="col-md-6">
                            <select name="pillar" class="form-control">
                                @foreach ($pillars as $pillar)
                                    <option value="{{ $pillar->id }}" title="{{ $pillar->pillar }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select name="tag" class="form-control">
                                @foreach ($tags as $tag)
                                    <option value="{{ $tag->id }}" title="{{ $tag->tagtitle }}">
