            ...
            <div class="tm_invoice tm_style1 tm_type1" id="tm_download_section">
                <div class="tm_invoice_in">
                    ...
                    <div>
                        ...
                        <h5 style="color:teal;">Progress Report Remarks</h5>
                        ...
                        <table class="table table-sm ">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $project->Comments1 }}</td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>Engagement in Student Involvement and Capacity Building</td>
                                    <td>{{ $project->Capacitybuilding }}</td>
                                    <td>{{ $project->Comments2 }}</td>
                                </tr>
                                <tr>
                                    <td>4</td>
                                    <td>Budget Utilization</td>
                                    <td>{{ $project->bidgetutilization }}</td>
                                    <td>{{ $project->Comments2 }}</td>
                                </tr>
                                <tr>
                                    <td>5</td>
                                    ...
                                    <td colspan="2"
                                        style="color: {{ $project->Recommentation_for_Continuation == 'Reject' ? 'red' : 'green' }};">
                                        {{ $project->Recommentation_for_Continuation == 'Reject' ? 'Rejected' : 'Accepted' }}
                                    </td>
                                </tr>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                @if (!empty($pg))
                                    @if ($project->Recommentation_for_Continuation == 'Reject')
