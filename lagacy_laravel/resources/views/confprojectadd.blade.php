    ...
    <br>
        <div class="container" id="box-form"
            ...
            <h5
                ...
                Add Conf-Tool Project</h5>
            <div class="container" id="box-form" style="  margin-top: 20; ">

                <form action="{{ route('confprojectsave', $cycle->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <tag class="error">
                        <?php if ($errors->any()) : ?>
                    ...
                    <table class="table-display" style="width:100%">
                        ...
                        <tr>
                            <td>Project Id</td>
                            <td><input class="form-control" type="text" name="old_project_id"></td>
                        </tr>
                        <tr>
                            <td><br></td>
                            <td></td>
                        ...
                        <tr>
                            <td><label for="">Pillars (Comma Seperated)</label></td>
                            <td>
                                <input class="form-control" type="text" id="pillars" name="pillars">
                            </td>
                        </tr>
                        <tr>
                            <td><br></td>
                        ...
                        <tr>
                            <td><label for="">Colleges (Comma Seperated)</label></td>
                            <td>
