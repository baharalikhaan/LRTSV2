...
@section('content')
    ...
    <body class="body">
        ...
        <br>
        @if ($type == 'LPI' or $type == 'LPI+Reviewer' or $type == 'Admin')
            ...
            <br>
        @endif
        @if ($type == 'Reviewer' or $type == 'LPI+Reviewer')
            <div class="col-md-12" style="margin-top: 10;">
                <div style="border: 2px solid teal;   border-radius: 30px 30px 30px 30px; background-color:#E9F6F6">
                    <div style=" margin: 40px;">
                        <table id="reviewertable" class="table table-striped">
                            <thead>
                                <tr>
                        ...
                        <div class="heading"> Projects for Review</div>
                    </div>
                </div>
            </div>
        @endif
        ...
        @if ($type == 'Reviewer' or $type == 'LPI+Reviewer')
            ...
            <div class="col-md-12" style="margin-top: 10;">
                <div style="border: 2px solid teal;   border-radius: 30px 30px 30px 30px; background-color:#E9F6F6">
                    <div style=" margin: 40px;">
                        <table id="reviewergraded" class="table table-striped">
                            <thead>
                                <tr>
                                    <th>Project Id</th>
                                    <th>Project Title</th>
                        ...
                        <div class="heading">Reviewer Graded Projects</div>
                    </div>
                </div>
            </div>
        </div> --}}
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#usertable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('project.ajaxList', ['c_id' => ':c_id']) }}".replace(':c_id', cycle),
                columns: [{
                        data: 'old_project_id',
                        name: 'old_project_id'
                    },
            ...
            $('#reviewertable').DataTable({
                ...
                "pageLength": 100,
                // Optional: force nowrap for others if needed
                columnDefs: [{
                    targets: [0, 1, 3, 4],
                    className: 'nowrap'
                }],
